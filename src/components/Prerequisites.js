...
// import components
import PrerequisitesSlider from './PrerequisitesSlider';

const Prerequisites = () => {
  // destructure prerequisites data
  const { icon, title, testimonials } = prerequisites;
  return (
      ...
      <div className='container mx-auto'>
        <div className='flex'>
          ...
          <div
            ...
            data-aos-delay='300'
          >
            <PrerequisitesSlider testimonials={testimonials} />
          </div>
        </div>
      </div>
    </section>
